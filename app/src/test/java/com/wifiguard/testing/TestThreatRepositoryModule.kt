 ...
 */
class FakePreferencesDataSource @javax.inject.Inject constructor() {
...
class FakeNotificationHelper @javax.inject.Inject constructor() : INotificationHelper {
    ...
    @Deprecated("Используйте showThreatNotification(networkBssid, threatLevel, title, content)")
...
@TestInstallIn(
    ...
    replaces = [com.wifiguard.di.RepositoryModule::class, com.wifiguard.di.NotificationModule::class]
)
@Module
