...
- **Устройство**: должно поддерживать Wi-Fi (требуется `android.hardware.wifi`)
...
│   ├── monitoring/          # Мониторинг подключений
...
│   ├── securityreport/      # Отчет по безопасности
...
- ✅ Уведомления об угрозах при подключении к небезопасным сетям
...
- `INTERNET` — для проверки сетевого подключения (данные не передаются)

## 📁 Документация

Дополнительная документация расположена в директории `docs/`:

- `docs/quickstart.md` — Быстрый старт
- `docs/architecture/` — Архитектура приложения
- `docs/user-guide/` — Руководство пользователя
- `docs/development/` — Руководство для разработчиков
- `docs/configuration/` — Конфигурация
- `docs/database/` — Данные и базы данных
- `docs/operations/` — Эксплуатация и troubleshooting

## ✅ Статус реализации

### Завершенные компоненты:
- ✅ **Core модули**: Wi-Fi сканер, анализ безопасности, база данных
- ✅ **Background monitoring**: WorkManager, уведомления об угрозах, автоматическое наблюдение за подключениями
- ✅ **UI экраны**: Сканер, анализ, настройки, уведомления, отчет по безопасности, о приложении, политика конфиденциальности, условия использования
...
- ✅ Безопасность данных
- ✅ Фоновый мониторинг
- ✅ Автоматические уведомления при подключении к небезопасным сетям

## 🚧 Дополнительные возможности

1. **Firebase интеграция**: Crashlytics, Analytics, Remote Config (настройка в BuildConfig)
